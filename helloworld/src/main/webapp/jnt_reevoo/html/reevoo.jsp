...
<script id="reevoomark-loader">
 (function() {
   var trkref = '<jcr:nodeProperty node="${currentNode}" name="trkref"/>';
...
<%--
<reevoo:mark sku="sample" trkref="ABC" baseURI="http://mark.reevoo.com/reevoomark/embeddable_reviews.html" />
 --%>

Reevoo code :<reevoo:mark sku="${currentNode.properties['sku'].string}" trkref="${currentNode.properties['trkref'].string}" baseURI="http://mark.reevoo.com/reevoomark/embeddable_reviews.html" />
